...
// the 21 reasons — three revealed at each light station
...
const STATION_TEXTS = [
  { fact: 'يبعُدُ ٢٥ سنةً ضوئية · غادرَهُ هذا الضوءُ نحوَ عامِ ٢٠٠١ — قبلَ أن تُولدي',
    personal: 'قبلَ أن تُوجَدي، كانَ الضوءُ في الطريق… وكانَ القدرُ يكتبُ أوّلَ سطرٍ فينا.' },
  { fact: 'يبعُدُ ١٩ سنةً ضوئية · غادرَ نحوَ ٢٠٠٧ — وكنتِ في الثانية',
    personal: 'كنتِ طفلةً تتعلّمينَ الكلام… وكانَ هذا الضوءُ يركضُ نحوَ ليلةٍ ستعرفينَ فيها أنَّكِ الكون.' },
  { fact: 'يبعُدُ ١٧ سنةً ضوئية · غادرَ نحوَ ٢٠٠٩ — وكنتِ في الرابعة',
    personal: 'النَّسرُ الطائرُ أطلقَ ضوءَهُ وأنتِ في الرابعة… كأنَّهُ عرفَ الموعدَ قبلَنا.' },
  { fact: 'نجمانِ توأمانِ يدورانِ حولَ بعضِهما منذُ الأزل · ضوؤُهُما غادرَ نحوَ ٢٠٠٩',
    personal: 'توأمانِ لا يفترقان… حينَ عرفتُكِ فهمتُ لماذا خلقَ اللهُ النجومَ أزواجًا.' },
  { fact: 'نجمٌ خافتٌ لا تراهُ العينُ المجرّدة · ١٣ سنةً ضوئية، غادرَ نحوَ ٢٠١٣',
    personal: 'كانَ يُحبُّكِ بصمتٍ من بعيدٍ دونَ أن تريه… مثلي، قبلَ أن تعرفيني.' },
  { fact: 'أوّلُ نجمٍ قاسَ البشرُ بُعدَهُ في التاريخ · ١١ سنةً ضوئية، غادرَ نحوَ ٢٠١٥',
    personal: 'عرفَ البشرُ كم يبعُدُ هذا النجم… وأنا عرفتُ أنْ لا مسافةَ بيني وبينَكِ.' },
  { fact: 'يبعُدُ ٢٢ سنةً ضوئية · هذا الضوءُ غادرَ نجمَهُ عامَ ٢٠٠٥ — عامَ وُلِدتِ',
...
export class SkyNight {
  ...
  whisperToStation() {
    ...
    w.textContent = last
      ? `بقيَ أقدمُ ضوءٍ… ضوءُ عامِ ٢٠٠٥ — انظري نحوَ ${dname}، ${h}، حيثُ يومِضُ نجمُ عامِ ميلادِك`
      : `ضوءٌ قديمٌ ينتظرُكِ نحوَ ${dname}، ${h}… اقتربي منهُ وأمسِكيهِ بإصبعِكِ حتى يكتمل`;
    w.classList.add('on');

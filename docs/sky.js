...
export const REASONS = [
  'ضحكتكِ ليست صوتاً أسمعه، بل هي النور الذي تبدأ منه حياتي كلما أظلمت.',
  'عيناكِ.. أنا لا أحتاج لغة للتحدث إليكِ، تكفيني نظرة لأقرأ كل ما تخبئه روحكِ.',
  'نورٌ يبحث عنه العالم في الشمس، بينما أنا أكتفي بكِ ليتبدد كل هذا الظلام.',
  'صوتكِ، في وسط هذا العالم المليء بالضجيج، هو اللحن الوحيد الذي ينبض عليه قلبي.',
  'مَعَكِ، أبسط الأشياء كالسير في شارعٍ فارغ، تتحول إلى مشهدٍ سينمائي لا يُنسى.',
  'غضبكِ الصغير وغيرتكِ.. تفاصيل تجعلكِ فاتنة لدرجة تجبرني على الاستسلام لكِ دائماً.',
  'وطني ليس مساحة من الأرض، وطني الحقيقي الذي أهرب إليه من كل العالم هو أنتِ.',
  'عنادكِ الذي يسلبني منطقي، أهزمه بالحب، وأُهزم أمامه بكل سرور.',
  'روحي تسبقني إليكِ في الفرح وفي الحزن.. لأنكِ أنتِ الوجهة والبداية والنهاية.',
  'صمتنا المشترك أبلغ من آلاف الكلمات.. فيه تتحدث أرواحنا وتتعانق بصمت.',
  'حُبٌّ يقولون أنه يحدث مرة بالعمر.. كذبوا، فأنا أقع في حبكِ من جديد كلما نظرتُ إليكِ.',
  'يَدُكِ حين تقبض على يدي، لا يهمني أي طريق أسلك، لأنكِ أنتِ الطريق.',
  'أمنيةٌ يطلبها الناس حين يسقط شهاب.. لكن في ليلتكِ، السماء أمطرت شهباً لتحتفل بأمنيتها التي نزلت للأرض.',
  'دمعتكِ تكسرني.. وأنا مستعد لمحاربة هذا الكون بأسره فقط لأحافظ على ابتسامتكِ.',
  'إيمانكِ بي حين تنظرين إليّ، يجعلني أشعر وكأنني أملك الكون بين يدي لأجلكِ.',
  'يومي لا يبدأ بشروق الشمس، يومي يبدأ فعلياً حين تفتحين عينيكِ.',
  'عُمَرٌ بأكمله مستعدٌ أن أقف فيه منتظراً.. لو كان ختام هذا الانتظار هو وجهكِ.',
  'قَدَرٌ أن تلتقي أرواحنا، وكأن قلبي عرفكِ وتعاهد معكِ في حياةٍ قبل هذه الحياة.',
  'قصةٌ كنت أنا فيها سطوراً ناقصة، حتى جئتِ أنتِ لتكوني أجمل اكتمال.',
  'غدٌ لا أرى فيه وجهكِ، هو غدٌ لا أريد أن أعيشه.. أنتِ مستقبلي وكل أيامي.',
  'نُـورة.. اسمٌ وامرأة لا تتكرر في تاريخ هذا الكون إلا مرة واحدة.. ولحسن حظي أنها قدري.',
];
...
const STATION_TEXTS = [
  { fact: 'يبعد ٢٥ سنة ضوئية · هذا الضوء غادره حوالي عام ٢٠٠١ — قبل أن تولدي',
    personal: 'قبل أن تولدي حتى، كان الضوء يركض نحوكِ.. وكان القدر يكتب أول سطرٍ في قصتنا الأبدية.' },
  { fact: 'يبعد ١٩ سنة ضوئية · غادر حوالي ٢٠٠٧ — وكنتِ وقتها في الثانية',
    personal: 'كنتِ طفلةً تتهجى الحروف، وهذا الضوء يقطع المجرات ليسقط الليلة في عينيكِ، ليخبركِ كم أنتِ غالية.' },
  { fact: 'يبعد ١٧ سنة ضوئية · غادر حوالي ٢٠٠٩ — وكنتِ في الرابعة',
    personal: 'أطلق النسر الطائر ضوءه وأنتِ في الرابعة.. وكأن السماء كانت تحضّر لموعدنا قبل أن نعرف نحن.' },
  { fact: 'نجمان توأمان يدوران حول بعضهما منذ ملايين السنين · ضوؤهما غادر حوالي ٢٠٠٩',
    personal: 'نجمان توأمان تعاهدا على البقاء معاً.. تماماً كما أدركتُ حين عرفتكِ، لماذا خُلقنا في هذا الكون أزواجاً.' },
  { fact: 'نجم خافت لا تراه العين المجردة · يبعد ١٣ سنة ضوئية، غادر حوالي ٢٠١٣',
    personal: 'نجمٌ خافت يحرسكِ من بعيد دون أن تريه.. كما كنتُ أنا، أحبكِ في الغيب قبل أن تجمعنا الأيام.' },
  { fact: 'أول نجم قاس البشر بُعده في التاريخ · يبعد ١١ سنة ضوئية، غادر حوالي ٢٠١٥',
    personal: 'قاس الفلكيون بعد هذا النجم بالأرقام.. وأنا وحدي من أدرك أن المسافة بين روحي وروحكِ هي "صفر".' },
  { fact: 'يبعد ٢١٫٣ سنة ضوئية في كوكبة ذات الكرسي · هذا الضوء غادر نجمه في ربيع ٢٠٠٥ — عام ولادتكِ · ولهذا النجم كواكب تدور حوله',
    personal: 'في العام الذي وُلدتِ فيه، انطلق هذا الضوء خصيصاً.. كأنه كان يبحث عنكِ ليخبركِ أنكِ الحدث الأهم في تاريخ هذا الكون.' },
];
...
export class SkyNight {
  ...
  whisperToStation() {
    ...
    w.textContent = last
      ? `بقي أقدم ضوء.. ضوء عام ٢٠٠٥ — انظري نحو ${dname}، ${h}، حيث يومض نجم عام ميلادكِ`
      : `هناك ضوء قديم ينتظركِ نحو ${dname}، ${h}.. اقتربي منه وأمسكيه بإصبعكِ حتى يكتمل`;
  ...
  completeStation() {
    ...
    if (this.stationIdx === 6) {
      const w = document.getElementById('whisper');
      if (w) { w.textContent = STATION_TEXTS[6].personal; w.classList.add('on'); }
      this.startFinale();
      return;
    }
    // station card
